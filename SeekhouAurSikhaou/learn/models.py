...
class StudentProfile(User):
    ...
    parent_field = models.ForeignKey('ParentProfile', on_delete=models.CASCADE, null=False, blank=False, related_name="students")
    class Meta:
...
#     student = models.ManyToManyField('Student', blank=False, related_name = "attendances")
...
#     teacher = models.ForeignKey('Teacher', on_delete=models.CASCADE, related_name="lecturenotes")
