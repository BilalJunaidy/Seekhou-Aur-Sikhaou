    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grade_level', models.CharField(blank=True, choices=[('GRADE5', 'Grade 5'), ('GRADE6', 'Grade 6'), ('GRADE7', 'Grade 7'), ('GRADE8', 'Grade 8'), ('GRADE9', 'Grade 9'), ('GRADE10', 'Grade 10'), ('GRADE11', 'Grade 11'), ('GRADE12', 'Grade 12'), ('GRADE13', 'Grade 13')], default='GRADE5', max_length=7)),
                ('type', models.CharField(blank=True, choices=[('STUDENT', 'Student'), ('TEACHER', 'Teacher'), ('PARENT', 'Parent'), ('ADMIN', 'Admin')], default='STUDENT', max_length=7)),
                ('gender', models.CharField(blank=True, choices=[('MALE', 'Male'), ('FEMALE', 'Female')], default='MALE', max_length=6, null=True)),
                ('age', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(7), django.core.validators.MaxValueValidator(100)])),
                ('is_teacher', models.BooleanField(default=False, verbose_name='Check box if the user is a teacher')),
                ('is_student', models.BooleanField(default=False, verbose_name='Check box if the user is a student')),
